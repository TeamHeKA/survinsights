...
from survinsight.local_explaination import individual_conditional_expectation, individual_conditional_expectation_2d
...
def plot_feature_interaction(h_stat_df):
	...
	for fname_pair in fname_pairs:
		...
		sns.lineplot(data=pair_df, x="times", y="H_stat", label=fname_pair[0] + "+" + fname_pair[1])
